...
public class Model implements InputProcessor {
    ...
    public boolean touchedUp = false;
...
//    }
    ...
    private void generateTrash() {
        String[] trashNames = new String[]{ "papel1", "papel2", "papel3", "papel4", "papel5",
                                            "plastico1", "plastico2", "plastico3",
                                            "lata1", "lata2", "lata3", "lata4",
                                            "vidro1", "vidro2", "vidro3", "vidro4",
                                            };
