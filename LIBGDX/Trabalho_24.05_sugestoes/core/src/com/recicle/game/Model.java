...
public class Model implements InputProcessor {
    ...
    public Model(FitViewport viewport, SpriteBatch batch, AssetsManager assMan) {
        ...
        /*bodyFactory.makeAllFixturesSensors(trashCanSensorB);
        bodyFactory.makeAllFixturesSensors(trashCanSensorR);
        bodyFactory.makeAllFixturesSensors(trashCanSensorY);
        bodyFactory.makeAllFixturesSensors(trashCanSensorG);*/
